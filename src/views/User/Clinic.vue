	...
	<div v-if="clinic" class="">
		<div class="mt-10 pb-10">
			<div class="grid lg:grid-cols-4 md:grid-cols-3 sm:grid-cols-2 gap-5 mb-5">
				<ClineCard v-if="clinic" :data="clinic" isUser="1" router="" />
				<div
					data-aos="flip-right"
			...
			<div
				...
				<div
					class="w-full flex items-center sm:justify-center gap-7 mb-5 overflow-x-scroll scrollbar-none">
					<div
						py-20
						flex
						items-center
				...
				<div v-if="clinicMenus.currentMenu == 0" class="text-start mx-auto">
					<ServicesUser :data="clinic" />
				</div>
				<div
					v-else-if="clinicMenus.currentMenu == 1"
					class="text-start mx-auto">
					<DoctorsUser :data="clinic" />
				</div>
				<div
					v-else-if="clinicMenus.currentMenu == 2"
					class="text-start mx-auto">
					<ServicesUser :data="clinic" price="1" />
				</div>
			</div>
		</div>
	</div>
